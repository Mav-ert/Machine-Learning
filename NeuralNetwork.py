...
class NeuralNetwork:
    ...
    def train_single(self, input, target_vector):
        # input and target_vector can be tuple, list or ndarray
    ...
    def run(self, input):
        ...
        if self.bias:
            ...
            input = np.concatenate( (input, [self.bias]) )
        in_vector = np.array(input, ndmin=2).T
