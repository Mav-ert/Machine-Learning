...
import random
import numpy as np
from game import SnakeGameAI, DIR, Point
...
class Agent:
    ...
    def get_state(self, game):
        ...
        dir_l = game.direction == DIR.LEFT
        dir_r = game.direction == DIR.RIGHT
        dir_u = game.direction == DIR.UP
        dir_d = game.direction == DIR.DOWN
    ...
    def get_action(self, state):
        ...
        return final_move
def train(gamma=0.9):
    print("Starting with gamma = {}".format(gamma))
    plot_scores = []
    plot_mean_scores = []
    total_score = 0
    record = 0
    ...
    while True:
        ...
        if done:
            ...
            if score > record:
                record = score
                agent.model.save()
                # print(list(agent.model.parameters()))
